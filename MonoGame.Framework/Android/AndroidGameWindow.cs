...
namespace Microsoft.Xna.Framework
{
	...
	public class AndroidGameWindow : Microsoft.Xna.Framework.AndroidGameView, Android.Views.View.IOnTouchListener, ISurfaceHolderCallback
	{
		...
		public AndroidGameWindow(System.IntPtr handle, Android.Runtime.JniHandleOwnership transfer) : base(handle, transfer) {
		}
		...
		protected override void CreateFrameBuffer()
		{
			...
			{
				throw new NotSupportedException("Could not create OpenGLES 2.0 frame buffer" + ex.ToString());
		    }
		}
	...
	protected override void OnClosed(EventArgs e)
		...
		{
			if (_game.GraphicsDevice != null && _contextWasLost && !closing) {
